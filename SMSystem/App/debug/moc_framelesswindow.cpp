...
#include "../../../Basic/Framework/framelesswindow.h"
...
QT_MOC_LITERAL(1, 16, 14), // "movableChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 16), // "resizableChanged"
QT_MOC_LITERAL(4, 49, 7), // "movable"
QT_MOC_LITERAL(5, 57, 9) // "resizable"

    },
    "FramelessWindow\0movableChanged\0\0"
    "resizableChanged\0movable\0resizable"
};
...
void FramelessWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FramelessWindow::movableChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FramelessWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FramelessWindow::resizableChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FramelessWindow::movableChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FramelessWindow::resizableChanged()
{
